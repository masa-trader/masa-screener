...
#  🎉 驗證通過：進入主網頁畫面
# =====================================================================
st.set_page_config(page_title="麻紗宅在家專屬股票過濾器", layout="centered", page_icon="🚀")
st.title("🚀 麻紗宅在家專屬股票過濾器")

# 🚨 官方聲明警語 (置頂顯眼處)
st.warning("⚠️ **【系統警語】** 本過濾器所有計算結果均由大數據分析所得，內容僅供技術分析教學與學術研究參考，絕無任何買賣推薦與投資建議。金融市場交易具備高度風險，使用上請務必搭配教學思維，審慎獨立思考並自行評估判斷。")
